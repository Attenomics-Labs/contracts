...
contract CreatorToken is ERC20 {
    ...
    // Keep track of total ERC20 supply
    ...
    /**
     * @param _name Token name (used by both ERC20 + ERC721).
     * @param _symbol Token symbol (used by both ERC20 + ERC721).
     * @param _totalSupply Total ERC20 supply.
     * @param _selfPercent x% to the creator's vault.
     * @param _marketPercent y% to the bonding curve.
     * @param _supporterPercent z% to the AI/Supporter contract.
     * @param _creator The address that will own this CreatorToken (NFT) and vault.
     * @param _aiAgent The address designated as the AI agent (owns the supporter).
     */
    constructor(
        string memory _name,
